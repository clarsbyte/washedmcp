...
import { Avatar, AvatarFallback, AvatarImage } from "@/components/landing-page/ui/avatar"
...
function TestimonialCard({
  ...
  return (
    ...
    >
      ...
      <blockquote className="relative z-10 flex-1 text-foreground leading-relaxed">
